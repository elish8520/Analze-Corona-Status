...
def build_ncov_geodf(day_df):
     world_lines = geopandas.read_file('./files/ne_50m_admin_0_countries.zip')
     ...
     china_provinces = geopandas.read_file('./files/gadm36_CHN.gpkg', layer='gadm36_CHN_1')
     china_provinces = china_provinces.rename(columns={'NAME_1': 'name'})

     china_cities = geopandas.read_file('./files/gadm36_CHN.gpkg', layer='gadm36_CHN_2')
     ...
     state_lines = geopandas.read_file('./files/ne_50m_admin_1_states_provinces.zip')
